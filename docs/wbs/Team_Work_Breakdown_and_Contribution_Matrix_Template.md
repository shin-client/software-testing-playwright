...
|   1.1A   | Tổng quan Playwright, Lịch sử & Triết lý Code-first                           | Soạn Mục 1.1 Chương 1 Báo cáo Word / LaTeX                             |       2.0%        | Lê Minh Quân      |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.1B   | Kiến trúc kết nối WebSocket CDP vs HTTP WebDriver                             | Soạn Mục 1.2 Chương 1 Báo cáo Word / LaTeX                             |       2.0%        | Trần Văn Ngọc     |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.2A   | Cơ chế Auto-waiting 5 bước & Actionability Checks                             | Soạn Mục 1.3 Chương 1 Báo cáo Word / LaTeX                             |       2.5%        | Đặng Duy Lam      |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.2B   | Cơ chế Browser Context Isolation & Tối ưu hóa Bộ nhớ RAM                      | Soạn Mục 1.4 Chương 1 Báo cáo Word / LaTeX                             |       2.5%        | Nguyễn Quốc Đương |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.3A   | Quy trình cài đặt môi trường, TypeScript, Playwright CLI & Codegen            | Soạn Mục 2.1 & 2.2A Chương 2 Báo cáo Word / LaTeX                      |       2.5%        | Ngô Gia Bảo       |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.3B   | Hướng dẫn chuyên sâu Playwright UI Mode & Trình gỡ lỗi Trace Viewer           | Soạn Mục 2.2B Chương 2 Báo cáo Word / LaTeX                            |       2.5%        | Lê Minh Tài       |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.4A   | Phân tích Năng lực Web UI (POM, Role-based Locators, `page.route()`)          | Soạn Mục 2.3 Chương 2 Báo cáo Word / LaTeX                             |       2.5%        | Lê Minh Quân      |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.4B   | Phân tích Năng lực API (`APIRequestContext`, Hybrid Auth, SOM)                | Soạn Mục 2.4 Chương 2 Báo cáo Word / LaTeX                             |       2.5%        | Nguyễn Hoài Linh  |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.5A   | So sánh đối sánh Playwright vs TestComplete (Kiến trúc & Chi phí TCO)         | Soạn Mục 4.1A Chương 4 Báo cáo Word / LaTeX                            |       2.0%        | Ngô Gia Bảo       |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.5B   | So sánh đối sánh Playwright vs Selenium 4 & Cypress (HTTP vs CDP, Multi-tab)  | Soạn Mục 4.1B Chương 4 Báo cáo Word / LaTeX                            |       2.0%        | Nguyễn Quốc Đương |                                                                            |    To Do    |                      |           0.00%           |          |
|   1.6    | Thiết lập Khung kiểm thử Multi-Project & GitHub Actions CI Pipeline           | Cấu hình `playwright.config.ts`, GitHub Actions CI & chạy pass lệnh    |       2.0%        | Trần Văn Ngọc     | [PR #1](https://github.com/shin-client/software-testing-playwright/pull/1) | In Progress |        95.0%         |           1.90%           |          |
|  **2**   | **API AUTOMATION SUITE**                                                      |                                                                        |      **30%**      |                   |                                                                            |             |                      |                           |          |
|   2.1    | API Ca 1: Auth Lifecycle, JWT & Single-use Token Rotation                     | Code `auth.spec.ts` & SOM `AuthService`, pass test & viết Báo cáo      |       7.5%        | Nguyễn Quốc Đương |                                                                            |    To Do    |                      |           0.00%           |          |
|   2.2    | API Ca 2: High-Contention Concurrency & Redis Redlock Race Condition Test     | Code `concurrency.spec.ts` (`Promise.all`), pass test & viết Báo cáo   |       7.5%        | Trần Văn Ngọc     |                                                                            |    To Do    |                      |           0.00%           |          |
|   2.3    | API Case 3: Booking Transaction & Idempotency Boundary Verification           | Code `booking.spec.ts` (`Idempotency-Key`), pass test & viết Báo cáo   |       7.5%        | Đặng Duy Lam      |                                                                            |    To Do    |                      |           0.00%           |          |
|   2.4    | API Case 4: RFC 9457 Problem Details Schema Validation & Rate Limiting        | Code `error.spec.ts` (Zod Schema), pass test & viết Báo cáo            |       7.5%        | Nguyễn Hoài Linh  |                                                                            |    To Do    |                      |           0.00%           |          |
|  **3**   | **WEB UI AUTOMATION SUITE**                                                   |                                                                        |      **25%**      |                   |                                                                            |             |                      |                           |          |
|   3.1    | UI Ca 1: Full E2E Checkout Flow với POM & COM trên SauceDemo                  | Code `checkout.spec.ts` & 5 Page Objects, pass test & viết Báo cáo     |       7.0%        | Lê Minh Quân      |                                                                            |    To Do    |                      |           0.00%           |          |
|   3.2    | UI Ca 2: Network Mocking `page.route()` HTTP 500 & Locked-out User            | Code `network.spec.ts` (CDP Interception), pass test & viết Báo cáo    |       6.0%        | Ngô Gia Bảo       |                                                                            |    To Do    |                      |           0.00%           |          |
|   3.3    | UI Ca 3: Post-Mortem Diagnostics với Trace Viewer & `performance_glitch_user` | Code `glitch.spec.ts` & xuất `trace.zip`, pass test & viết Báo cáo     |       6.0%        | Lê Minh Tài       |                                                                            |    To Do    |                      |           0.00%           |          |
|   3.4    | UI Ca 4: Visual Regression Testing & Dynamic Data Masking                     | Code `visual.spec.ts` (`toHaveScreenshot`), pass test & viết Báo cáo   |       6.0%        | Lê Minh Tài       |                                                                            |    To Do    |                      |           0.00%           |          |
...
|   4.2A   | Thiết kế Slide Phần 1, 2 & 3: Mở đầu, Lý thuyết & Kiến trúc (Slide 1 $\to$ 12) | Thiết kế Master Layout, Slide Phần 1, 2 và Phần 3 Framework            |       3.0%        | Nguyễn Quốc Đương |                                                                            |    To Do    |                      |           0.00%           |          |
|   4.2B   | Thiết kế Slide Phần 4 & 5: Thực nghiệm 8 Ca Test & Tổng kết (Slide 13 $\to$ 25)| Thiết kế Slide 8 ca test thực nghiệm, ma trận so sánh & tổng kết đóng góp|       3.0%        | Trần Văn Ngọc     |                                                                            |    To Do    |                      |           0.00%           |          |
